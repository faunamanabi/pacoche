...
title: Ocupación, bajo el modelo estático (MacKenzie et al. 2002) para para las especies
  de mamíferos en el Refugio de Vida Silvestre Marino Costera Pacoche 
...
Las trampas cámara permanecieron activas desde final de septiembre 204 hasta mayo 2015.
...
pacoche.raw<-read.csv("C:/Users/Diego/Documents/CodigoR/ULEAM/Infor_Caract/Data/CT-RVP-2014a.csv") # ojo falta la camara 3-12
...
Inicialmente se seleccionaron cinco covariables para ajustar los modelos de ocupación. Estas cinco covariables fueron: Altitud (elev) y Pendiente (slope), como covariables geográficas y altura del dosel, cobertura del dosel y área basal como covariables que se midieron momento de retirar las cámaras. Estas tres últimas covariables se midieron usando la metodología del cuadrante centrado en un punto. 

La Altitud se obtuvo de una imagen SRTM del repositorio de [CGIAR](http://srtm.csi.cgiar.org/). La pendiente se infirió a partir de la altitud. 
...
library(maptools)
 ...
 # pacoche.raw<-read.csv("C:/Users/Diego/Documents/CodigoR/ULEAM/Infor_Caract/Data/CT-PNM-2014.csv") # ojo falta la camara 3-12
...
elevationpaco<- raster("C://Users//Diego//Documents//CodigoR//ULEAM//Infor_Caract//code//srtm_20_13.tif")
...
# roadpol <- readShapeSpatial("C:/Users/Diego/Documents/CodigoR/ULEAM/Infor_Caract/shp/pacoche_roadsclip.shp")
...
####################################
## fill artificially the NA
####################################

cam.and.covs[45,5]<-50
cam.and.covs[45,6]<-5

##################
# Delete array 4
#################
# cam.and.covs<-cam.and.covs[1:54,]
...
est.veget<-read.csv("C:/Users/Diego/Documents/CodigoR/ULEAM/Infor_Caract/Data/estructVegetPacoche.csv") # read table
...
## El yagouaroundi (_Puma yagouaroundi_)
...
f.sp.occu.plot.mat(sp_number = 15)
```

### Seleccion de Modelos
```{r modeo_sps8,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,results='asis'}
print(as.character(sp.names[sp_number=15]))
f.sp.occu.models(sp_number = 15)
```
...
```{r mat_sp23,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=4,fig.width=7}
 f.sp.occu.plot.mat(sp_number = 29)
```

### Seleccion de Modelos
```{r modeo_sps23,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,results='asis'}
print(as.character(sp.names[sp_number=29]))
f.sp.occu.models(sp_number = 29)
```
...
```{r mat_sp5a,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=4,fig.width=7}
 f.sp.occu.plot.mat(sp_number = 5)
```

### Seleccion de Modelos
```{r modeo_sps5a,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,results='asis'}
